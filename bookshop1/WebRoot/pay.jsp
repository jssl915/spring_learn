...
.table1{table-layout:fixed;empty-cells:show;border-collapse:collapse;border:1px solid #9dc7f1;}
.table1 td,.table1 tr{border:1px solid #6e9fd0;padding:0 1em 0;line-height:30px; text-align:center}
</style>
<script>
...
<body>
<form id="form1" action="OrderClServlet" method="post">
<div id="wrap">
   <div class="header">
   ...
   <div class="center_content" style="margin:20px 0 10px 50px">
        <table class="t_login">
          <tr>
              <td align="right" width="100px;height:30px;">收货人姓名：</td>
              <td width="200px"><input type="text" id = "conName" name="conName" style="height:20px;width:200px"></td>
          </tr>
          <tr>
              <td align="right" width="100px;height:30px;">收货地址：</td>
              <td width="200px"><input type="text" id = "conAddress" name="conAddress" style="height:20px;width:200px"></td>
          </tr>
          <tr>
              <td align="right" width="100px;height:30px;">手机号：</td>
              <td width="200px"><input type="text" id = "conPhone" name="conPhone" style="height:20px;width:200px"></td>
          </tr>
          <tr>
              <td align="right" width="100px;height:30px;">邮编：</td>
              <td width="200px"><input type="text" id = "conZipcode" name="conZipcode" style="height:20px;width:200px"></td>
          </tr>
          <tr id="errorMessage"><td></td><td style="color:red;font-size:14px;" align="left" id="error"></td></tr>
        </table>
	</div>
    <div>
    	<table class="table1" style="margin:10px 0 0 90px">
    	<input type="hidden" name="bookId" value="${book.bookId}">
            ...
            <tr>
            	<td><img src="${img}/books/${book.bookImage}" alt="" title="" border="0" style="width:25px;height:37px"/></td>
            	<td><<${book.bookName}>></td>
    ...
    <div style="margin:20px 0 0 200px"><a href="#" onclick="orderSubmit()"><img src="${img}/qd.gif" border="0" width="80" height="20"></a></div>
