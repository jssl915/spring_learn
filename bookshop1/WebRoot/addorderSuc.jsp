...
<div id="wrap">
   <div class="header">
        ...
        <div id="menu">
            ...
            <li><a href="characteristic.jsp">特色书籍</a></li>
   ...
   <div style="position:relative;top:50px;left:250px;height:250px">
    ...
    <div style="position:absolute;left:220px;top:38px;font-size:14px;">恭喜您已经成功订购该商品!</div>
    <div style="position:absolute;left:130px;top:120px;"><a href="IndexClServlet?flag=1"><img src="${img}/gmcg.jpg"></a></div>
   </div>
   <br>
   <div class="footer">
