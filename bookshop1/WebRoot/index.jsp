...
<script>
function firstPage(){
	location.href ="PageClServlet?page=1";
}
function upPage(){
	...
	location.href ="PageClServlet?page="+page;
}
function downPage(){
	var page  = ${currentPage};
...
function endPage(){
	location.href ="PageClServlet?page=${pageCount}";
}
...
document.onkeydown=function(event){
    ...
    switch(key) {    
        case 13: {
        	location.href ="PageClServlet?page="+$('#currentPage').val();
        	}
        break;
   }     
}
...
function bookInfo(bookId){
	location.href ="BookClServlet?bookId="+bookId;
}
...
<div id="wrap">
   ...
   <div class="center_content">
    ...
    <div style="margin-left:320px;"> 
	 ...
	 &nbsp;第 <input type="text" name="currentPage" id="currentPage" value="${currentPage}" style="width:30px"> 页  
	 &nbsp; 共 ${pageCount} 页	 
