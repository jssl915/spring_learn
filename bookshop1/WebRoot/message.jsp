...
<body>
<form id="form1" action="MessageClServlet" method="post">
<div id="wrap">
   <div class="header">
   ...
   <div class="center_content">
       	...
       	<div class="crumb_nav">
            <a href="IndexClServlet?flag=1">Home</a> &gt;&gt; Message Board
            </div>      	
            <div class="title"><span class="title_icon"><img src="${img}/bullet1.gif" alt="" title="" /></span>留言板</div>        
        	<c:forEach items="${bookList}"  var="book" varStatus="status">
	        	<div class="feat_prod_box">            
	            	<div class="prod_img"><a href="#" onclick="bookInfo(${book.bookId})"><img src="${img}/books/${book.bookImage}" alt="" title="" border="0" style="width:128px;height:150px"/></a></div>                
	                <div class="prod_det_box">
	                    <div class="box_center">
	                        <div class="prod_title"> <<${book.bookName}>> </div>
	                        <p class="details">${book.remark}</p>
	                        <a href="#" onclick="bookInfo(${book.bookId})" class="more">- more details -</a>
	                        <div class="clear"></div>
	                    </div>                    
   ...
   <div class="mainBox">
    <div style="margin:50px 0 0 80px">
       <table>
			...
			<tr><td>标题：</td><td><input type="text" name="messTitle"></td></tr>
			<tr><td>作者：</td><td><input type="text" name="messAuthor"></td></tr>
			<tr><td>内容：</td><td><textarea name="messContent" cols="30" rows="6"></textarea></td></tr>
			<tr><td colspan="2">
					<input type="submit" value="添加"" style="color:#666;width:60px;height:28px">
	                <input type="reset" value="重置" style="color:#666;width:60px;height:28px">
				</td>
			</tr>
		</table>
    </div>
