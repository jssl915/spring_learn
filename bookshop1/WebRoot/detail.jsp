...
<body>
<form id="form1" action="PayClServlet" >
...
<div id="wrap">
   <div class="header">
        ...
        <div id="menu">
            ...
            <div style="position:absolute;left:1020px;top:165px;font-size:20px;color:green"><li><a href="login.jsp">切换账号</a></li></div>
        </div>
   ...
   <div class="center_content">
       	...
       	<div class="crumb_nav">
            <a href="IndexClServlet?flag=1">Home</a>&gt;&gt; Chinese Books
            </div>       	
           <div class="title"><span class="title_icon"><img src="${img}/bullet1.gif" alt="" title="" /></span>中文书籍</div>        
        	<div class="feat_prod_box">            
            	<div class="prod_img"  style="position:relative" >
                	<div style="position:relative;top:5px"><img src="${img}/books/${book.bookImage}" alt="" title="" border="0" style="width:128px;height:150px"/></div>
                    <div style="position:relative;top:10px">价格:<span style="color:#F8981D">￥${book.bookPrice}</span></div>
                </div>
                                
                <div class="prod_det_box">
                    <div class="box_center">
                        <div class="prod_title"> 书名：<<${book.bookName}>></div>
                        <div class="prod_title" style="color:#3366CC;font-size:14px;border-bottom:#999999 dotted;margin:2px 0 0 14px;padding:5px 0 10px 2px">
                        	作者：${book.bookAuthor}&nbsp;&nbsp;类型：${book.bookType}
                        </div>
                        <p class="details">
                            ${book.remark}                         
                            </p>
                    ...
                    <div style="margin:20px 0 0 250px"><a href="#" onclick="pay();"><img src="${img}/but_buy.gif" border="0" width="144" height="35"></a></div>                  
