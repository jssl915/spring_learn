...
<form id="form1" action="IndexClServlet" method="post">
<div id="CSS3_box">
   <br class="clearB" /> 
   <div class="mainBox">
   	<h1>登录</h1>
    ...
    <table class="t_login">
      ...
      <tr>
	      ...
	      <input type="button" value="登录" onclick="login();" style="color:#666;width:60px;height:28px">
	      <input type="reset" value="清空" style="color:#666;width:60px;height:28px">
	      <input type="button" value="注册" onclick="register();" style="color:#666;width:60px;height:28px">
	      </td>
      </tr>
  	</table>
    </div>
